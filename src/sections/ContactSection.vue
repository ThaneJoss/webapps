          ...
          <div class="contact-entry-card__inner">
            ...
            >
              <template v-if="isCardActive(entry.id)">
                <button
                  type="button"
                  class="absolute right-3 top-3 z-10 inline-flex h-9 w-9 items-center justify-center rounded-full border border-[#17304b]/14 bg-white/86 text-[#123a63] shadow-[0_8px_18px_rgba(10,22,40,0.08)] transition hover:border-cyan-500/30 focus:outline-none focus:ring-2 focus:ring-cyan-400/45"
