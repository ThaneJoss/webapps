...
const homeApps = [
  {
    ...
    status: '优先上线',
    path: '/apps/app-01',
    description: '作为首页的主入口，优先承接最核心的使用流程，后续会率先接入完整功能。',
    phase: '首发版本',
    tip: '先完成核心闭环',
    featured: true,
  ...
  },
  {
    ...
    status: '规划中',
    path: '/apps/app-02',
    description: '快速收集网页、文本与链接内容，方便后续整理、筛选与再利用。',
    phase: '待补业务内容',
    tip: '后续扩展',
    featured: false,
  ...
  },
  {
    ...
    status: '规划中',
    path: '/apps/app-03',
    description: '集中查看关键数据、状态变化与趋势，适合做一眼就能读懂的总览页。',
    phase: '待定义结构',
    tip: '后续扩展',
    featured: false,
  ...
  },
  {
    ...
    status: '规划中',
    path: '/apps/app-04',
    description: '随手记录想法、草稿和待办，把零散内容先收进同一个入口。',
    phase: '待接表单交互',
    tip: '后续扩展',
    featured: false,
  ...
  },
  {
    ...
    status: '规划中',
    path: '/apps/app-05',
    description: '上传、分类和归档常用文件，适合做轻量但清晰的资料整理页。',
    phase: '待接上传流程',
    tip: '后续扩展',
    featured: false,
  ...
  },
  {
    ...
    status: '规划中',
    path: '/apps/app-06',
    description: '统一管理提示词、模板和测试结果，方便持续迭代与复用。',
    phase: '待补工作流',
    tip: '后续扩展',
    featured: false,
  ...
  },
  {
    ...
    status: '规划中',
    path: '/apps/app-07',
    description: '把内容整理成可发布版本，承接导出、分发和上线前检查。',
    phase: '待接操作面板',
    tip: '后续扩展',
    featured: false,
  ...
  },
  {
    ...
    status: '规划中',
    path: '/apps/app-08',
    description: '用来试验新功能、新交互和新想法，适合快速验证方向。',
    phase: '待搭实验区',
    tip: '后续扩展',
    featured: false,
  ...
  },
  {
    ...
    status: '规划中',
    path: '/apps/app-09',
    description: '管理应用状态、内容配置和基础数据，作为内部使用的操作入口。',
    phase: '待补权限逻辑',
    tip: '后续扩展',
    featured: false,
  ...
  },
  {
    ...
    status: '规划中',
    path: '/apps/app-10',
    description: '串联联系页、表单页和留言页，把反馈、线索和回访放到一起。',
    phase: '待接联动入口',
    tip: '后续扩展',
    featured: false,
